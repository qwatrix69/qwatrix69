...
################################################################################
# CLOCKS
create_clock -period 5.000 -name clk_1 -waveform {0.000 2.500} [get_ports clk_1]
################################################################################

# SYSCLK 200MHz
set_property PACKAGE_PIN E19 [get_ports clk_1]
set_property IOSTANDARD LVDS [get_ports clk_1]
set_property PACKAGE_PIN E18 [get_ports clk_2]
set_property IOSTANDARD LVDS [get_ports clk_2]
